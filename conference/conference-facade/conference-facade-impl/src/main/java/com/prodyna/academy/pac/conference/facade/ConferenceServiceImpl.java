...
public class ConferenceServiceImpl implements ConferenceService {
	 ...
	 * @param conferenceF
	 * @throws BusinessException if the date fields are invalid
	 */
	private void validateConference(Conference conference) throws BusinessException{
		...
		for (Talk talk : talks) {
			...
			boolean talkIntervalInsideConferenceInterval = interval.contains(talkInterval);
